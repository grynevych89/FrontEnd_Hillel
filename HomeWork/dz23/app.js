 $(document).ready(function() {
    $('form').submit(function() {
        $.get('http://api.openweathermap.org/data/2.5/weather?q=' + $('#weather_input').val()
            + '&units=metric&APPID=5d066958a60d315387d9492393935c19&lang=uk', function(data) {
            let html_str = "";
            ...
            html_str += `<img src='http://openweathermap.org/img/w/${data.weather[0].icon}.png'></img>`;
